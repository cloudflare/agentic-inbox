...
export const adminApi = {
	...
	getDomains: () => call<{ domains: string[] }>("/api/v1/admin/domains"),
	addDomain: (domain: string) => call<{ domains: string[] }>("/api/v1/admin/domains", "POST", { domain }),
	removeDomain: (domain: string) => call<{ domains: string[] }>("/api/v1/admin/domains", "DELETE", { domain }),
